  ...
  return (
    ...
    <div>
      <Switch>
        ...
        <Route exact path="/Addpro" component={Addpro}></Route>
        <Route exact path="/Getpro" component={Getpro}></Route>
        <Route exact path="/Updatepro" component={Updatepro}></Route>
        <Route exact path="/Deletepro" component={Deletepro}></Route>
