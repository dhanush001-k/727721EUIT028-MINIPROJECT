  ...
  <div className="slide-container">
        <Slide>
         {Images.map((slideImage, index)=> (
            <div key={index}>
              <div id="slideimg" style={{ ...divStyle, 'backgroundImage': `url(${slideImage.url})`,height:'500px'}}>
...
<div className='footer'>
      <div className="footer-box">
        ...
        <a href="#" className="footer-link">Call Center</a>
        <a href="https://mail.google.com/mail/u/0/#inbox" className="footer-link">Email Us</a>
        <a href="#" className="footer-link">Help Center</a>
      </div>
      <div className="footer-box">
        <p className="footer-heading">Support & Resources</p>
      ...
      <div className="footer-box">
        ...
        <a href="#" className="footer-link">Terms and Policy</a>
        {/* <a href="#" className="footer-link">Community</a> */}
      </div>
      <div className="footer-box">
        <br></br>
        <div className="footer-hr"></div>
        <p className="footer-bottom">© 2023 Your Copyrights. All rights reserved.</p>
      </div>
    </div>
