...
<ul id="ulis">
  ...
  <li class="dropdown" id="lis">
    ...
    <div class="dropdown-content">
      ...
      <a href="#">Grain products</a>
      <a href="#">BabyCare products</a>
      <a href="#">Cool drinks and beverages</a>
    </div>
  </li>
  ...
  <li id="lis"><a href="#news" className='ha'>Cart</a></li>
      ...
      >
        ...
        <div className='sch1'>
<br></br>
  <input type='search' placeholder='Search fruits' className='search1'></input>
 &nbsp;
  <Button variant="contained" className='homebutton1' sx={{ fontSize: 13 ,bgcolor: "#66FFB2",color:"black",height:50,width:100}}>Search</Button><br></br><br></br>
    ...
    <div id="wbox">
          ...
          <div id="im3">
          <h1 className='fruits'>Baby Care products</h1>
          </div>
          <div id="im4">
